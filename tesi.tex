% My master's degree thesis source code
% Author: Alessandro Righi <alessandro.righi@alerighi.it>
% Feel free to copy the template/structure of this document

% compatibilità per standard PDF-A
\begin{filecontents*}[overwrite]{\jobname.xmpdata}
    \Title{Automazione di test di accettazione per dispositivi IoT embedded integrati nel cloud}
...
\usepackage[bookmarks,pdfa]{hyperref}
