...
\footnotetext[1]{Include oltre al tempo per svolgere il test il tempo necessario per leggere 
    i passi da svolgere, assicurarsi che il RE sia alle condizioni iniziali, ed alla fine del 
    test aggiornare il documento con l'esito}
\footnotetext[2]{Tempo necessario per predisporre l'ambiente ed il materiale per poter iniziare
    a svolgere i test}
\footnotetext[3]{Tempo di esecuzione lanciando assieme tutti i test, potrebbe non corrispondere
