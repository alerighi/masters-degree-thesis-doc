...
\newglossaryentry{micro}{
    ...
    description={Componente elettronico che integra in un unico chip processore, memoria
        RAM, memoria flash, gestione delle periferiche di input/output. Tipicamente offre 
...
\newglossaryentry{awsjob}{
    ...
    description={Sistema di distribuzione di processi batch da eseguire sui dispositivi collegati ad \Gls{iotcore}. 
        Ogni processo è idetnificato da un documento JSON, a libera scelta di chi lo crea, che il dispositivo interpreta 
...
\newglossaryentry{git}{
    name={Git},
    description={Sistema di versionamento del codice sorgente gestito distribuito. Creato inizialmente da Linus 
...
\begin{figure}[ht]
    \centering
    \begin{tikzpicture}
        \node[rectangle, draw, align=center, inner sep=8pt] (root) {root CA \\\Gls{mqtt}};
